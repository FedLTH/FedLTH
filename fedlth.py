    ...
    for round in range(args.com_round):
        ...
        if early_train_phase==False and sp_round < max_sp_rounds:
            ...
            if pruner.ratio >= pruner.end_ratio and pruner.unpruned_flag:
                ...
                sparisty=pruner.structured_prune(model,weight_with_mask,train_loader,criterion,num_classes)
                print(f'Prune Phase {sp_round+1}/{max_sp_rounds}[Refill Struct Prune]: Final sparsity:' + str(100 * sparisty) + '%')
